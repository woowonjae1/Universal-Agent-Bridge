...
const plan = {
  ...
  steps: [
    ...
    },
    {
      ...
      dependsOn: ["write"],
      method: "agent",
      params: { message: "Rewrite this slogan to make it extremely punchy and professional: ${steps.write.result.result.payloads.0.text}" }
    }
  ]
};

// Hook into private state by overriding evaluatePlanCondition or evaluateTemplateString
// Or simpler, just print the JSON representation of the final run result
